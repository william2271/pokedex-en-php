<?php
	...
	ModificarPokemon($_POST['ID'], $_POST['Foto'], $_POST['Nombre'], $_POST['Tipo'], $_POST['Ataque1'], $_POST['Ataque2'], $_POST['Ataque3'], $_POST['Ataque4'], $_POST['Region']);

	function ModificarPokemon($ID, $Foto, $Nombre,$Tipo,$Ataque1,$Ataque2,$Ataque3,$Ataque4,$Region)
	{
